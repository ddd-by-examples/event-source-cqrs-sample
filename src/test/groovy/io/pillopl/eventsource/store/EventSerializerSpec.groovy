...
import io.pillopl.eventsource.infrastructure.InfrastructureConfiguration
...
class EventSerializerSpec extends Specification {
    ...
    @Subject
    EventSerializer eventSerializer = new EventSerializer(new InfrastructureConfiguration().objectMapper())
